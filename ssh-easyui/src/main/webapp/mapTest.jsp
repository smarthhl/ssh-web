...
<body>
	...
	<input class="easyui-datebox" id="beginDate" name="beginDate" style="width: 100px;"></input> 
	-
	<input class="easyui-datebox" id="endDate" name="endDate" style="width: 100px;"></input>
    ...
    function query(){
        ...
        var url = '<%=basePath%>app!redLocation.action?beginDate='+beginDate+'&endDate='+endDate+'&app_key='+app_key;
    ...
    $(document).ready(function() {
		...
		function EconfigAPI(url) {
			...
			//'echarts/theme/macarons',
			 'echarts/chart/map' ], function(ec, theme) {
				// --- 地图 ---
				var myChart = ec.init(document.getElementById('mainMap'),theme);
