...
<div region="center" style="padding:5px;" border="false"> 
	<div>
		...
		<table id="dg" class="easyui-datagrid" style="height: 520px;"
			url="app!evnEffectPage?rptFlag=productRpt" toolbar="#toolbar" pagination="true"
			rownumbers="true" fitColumns="true" singleSelect="true"
			align="center">
			<thead>
				<tr>
				<th field="date_key" width="40">交易日期</th>
				<th field="goods" width="40">购买产品名称</th>
				<th field="accu_trad_cnt" width="40">产品累计交易总人数</th>
				<th field="accu_trad_amt" width="40">产品累计交易总金额</th>
				<th field="curr_trad_cnt" width="40">产品当天交易总人数</th>
				<th field="curr_trad_amt" width="40">产品当天交易总金额</th>
				</tr>
			</thead>
		</table>
	</div>	
