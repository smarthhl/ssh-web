...
<div region="center" style="padding:5px;" border="false"> 
	<div>
		...
		<table id="dg" class="easyui-datagrid" style="height: 520px;"
			url="app!evnEffectPage?rptFlag=accuRpt" toolbar="#toolbar" pagination="true"
			rownumbers="true" fitColumns="true" singleSelect="true"
			align="center">
			<thead>
				<tr>
				<th field="date_key" width="40">日期</th>
				<th field="accu_act_cnt" width="40">激活成功数</th>
				<th field="accu_reg_cnt" width="40">注册成功人次</th>
				<th field="accu_log_cnt" width="40">登录成功人次</th>
				<th field="accu_auth_cnt" width="40">认证成功人次</th>
				<th field="accu_bind_cnt" width="40">绑卡成功人次</th>
				<th field="accu_po_cnt" width="40">下单总数</th>
				<th field="accu_trad_cnt" width="40">交易成功数</th>
				<th field="accu_trad_amt" width="40">交易金额</th>
				</tr>
			</thead>
		</table>
	</div>
